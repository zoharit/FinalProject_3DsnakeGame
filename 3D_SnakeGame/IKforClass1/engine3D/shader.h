...
public:
	...
	void Bind();
	void Update(glm::mat4 MVP, glm::mat4 Normal, int const shpIndx, std::vector<glm::mat4> T, glm::vec4* ambient, glm::vec3* eye,glm::vec4* diffuse, glm::vec4* specular, int bonus);
	virtual ~Shader();
protected:
private:
	static const unsigned int NUM_SHADERS = 2;
	static const unsigned int NUM_UNIFORMS = 11;
